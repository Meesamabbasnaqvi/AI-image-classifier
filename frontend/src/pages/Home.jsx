    ...
    <div className="relative min-h-screen overflow-x-hidden bg-slate-50 flex flex-col justify-between flex-1">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 py-12 md:px-12 md:py-20 text-center flex-1">
        ...
        <section className="mt-24 md:mt-32 ">
          ...
          <div className="mt-12 grid gap-9 sm:grid-cols-2 lg:grid-cols-4 text-left widht-box">
            {features.map((feat, idx) => {
              const Icon = feat.icon;
              return (
                <div
                  key={idx}
                  className="w-120 rounded-3xl border border-slate-100 bg-white p-6 shadow-md transition-all duration-300 hover:border-indigo-100 hover:shadow-xl hover:-translate-y-1"
                >
